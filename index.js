...
class Car {
  ...
  fill(gallons){
    ...
    return `You have ${this.tank} gallons of gas`
  }
  drive(distance){
    const drivableMiles = this.tank * this.milesPerGallon;
    if(distance <= drivableMiles){
      this.odometer = this.odometer + distance; //a
      this.tank = this.tank - (distance / this.milesPerGallon) //b
    } else {
...
const e21 = new Car('1981 BMW 318is', 10);
...
// const ethan = new Lambdasian({
//   name: 'ethan',
//   age: 20,
//   location: 'Texas'
// });

// console.log(ethan.speak())
